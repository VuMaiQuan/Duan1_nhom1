...
public class LayerForm extends JLayeredPane {
    ...
    public void loadLoginUI() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RavenLogin.main.MainLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RavenLogin.main.MainLogin().setVisible(true);
            }
        });
    }
